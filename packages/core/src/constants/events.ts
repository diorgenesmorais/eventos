...
const events: Event[] = [
    ...
    {
        id: Id.get(),
        identifier: 'evento-dev-frontend',
        password: 'front123',
    ...
    {
        id: Id.get(),
        identifier: 'casamento-alberto-marina',
    ...
    {
        id: Id.get(),
        identifier: 'inauguracao-loja-estrela',
    ...
    {
        id: Id.get(),
        identifier: 'reuniao-familia-oliveira',
